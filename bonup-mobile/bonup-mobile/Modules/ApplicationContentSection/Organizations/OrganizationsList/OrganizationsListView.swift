...
final class OrganizationsListView: BUContentViewController {
    ...
    private var collectionView: BUCollectionView!
    ...
    private func setupSubviews() {
        ...
        self.emptyContainer = self.configureEmptyContainer()
    ...
    private func setupNavigationBar() {
        ...
        self.loc_title = "ui_organization_title"
    }
    
    // MARK: - Configurations
    
    private func configureEmptyContainer() -> BUEmptyContainer {
        
        let container = BUEmptyContainer()
        
        container.image = AssetsHelper.shared.image(.emptyTasksListIcon)
        container.loc_description = "ui_empty_organizations_title"
    ...
    private func configureCollectionView() -> BUCollectionView {
