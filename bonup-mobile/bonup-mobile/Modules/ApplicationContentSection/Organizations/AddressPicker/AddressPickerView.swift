...
final class AddressPickerView: BUContentViewController {
    ...
    private var tableView: BUTableView!
    ...
    private func configureDoneButton() -> UIButton {
        ...
        let button = BUButton(type: .system)
        ...
        button.loc_title = "ui_done_title"
    ...
    private func configureTableView() -> BUTableView {
        
        let tableView = BUTableView()
    ...
    private func configureSearchBar() -> BUSearchBar {
        ...
        bar.loc_placeholder = "ui_enter_location_placeholder"
...
extension AddressPickerView: EmptyDataSetSource {
    ...
    func title(forEmptyDataSet scrollView: UIScrollView) -> NSAttributedString? {
        ...
        return NSAttributedString(string: "ui_empty_suggests_list_message".localized,
