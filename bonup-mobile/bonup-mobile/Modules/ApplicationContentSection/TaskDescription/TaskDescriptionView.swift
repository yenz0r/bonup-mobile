...
final class TaskDescriptionView: UIViewController {
    ...
    private var adBanner: GADBannerView!
    ...
    private func setupSubviews() {
        ...
        self.adBanner = self.configureAdBanner()
    ...
    private func configureNavBar() {
        self.navigationItem.title = "ui_task_details".localized
    ...
    private func configureMapView() -> YMKMapView {
    ...
    private func configureAdBanner() -> GADBannerView {
        let banner = GADBannerView()

        banner.adUnitID = "ca-app-pub-4243143975731364/2569848784"
